...
function b()
{
	...
	document.getElementById("text").innerHTML="Draw the apparent front view of Pentagon inclined to HP(θ) ";
...
function c()
{
	...
	document.getElementById("text").innerHTML="Draw the top view of Pentagon inclined to HP(θ)";
...
function d() 
{
	...
	document.getElementById("text").innerHTML="Draw the side on the HP making of Pentagon inclined to VP(α)";
	ctx.beginPath();
  ...
  function e() {
	...
	ctx.lineTo(400+100*Math.cos(Math.PI/3),200+100*Math.sin(Math.PI/3));
	ctx.stroke();
